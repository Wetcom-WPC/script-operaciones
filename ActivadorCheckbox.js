...
// Incluye RVTools (U) — ahora también manejado por el trigger de tiempo
const COLS_MANEJADAS_POR_TIMER = [COL_CHECK_VSPHERE, COL_CHECK_VEEAM, COL_CHECK_NUTANIX, COL_CHECK_RVTOOLS];
