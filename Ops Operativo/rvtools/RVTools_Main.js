...
function procesarRVToolsManual(clientName, rvToolsFolderId) {
  ...
  for (const file of filesToProcess) {
    ...
    try {
      ...
      // Creamos una copia temporal en Google Sheets para poder leerla usando Backoff para rate limit
      const tempSheetFile = executeDriveWithBackoff(() => Drive.Files.copy(
